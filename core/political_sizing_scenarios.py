...
class PoliticalSizingScenario:
    ...
    def __post_init__(self) -> None:
        ...
        for value in (self.position_cap, self.total_reserved_cap):
...
def required_political_sizing_scenarios() -> tuple[PoliticalSizingScenario, ...]:
    ...
    return (
        PoliticalSizingScenario(
            "control_p25_t100", Decimal("25"), Decimal("100"), 4, "control"
        ),
        PoliticalSizingScenario(
            "cf_p50_t100", Decimal("50"), Decimal("100"), 4, "counterfactual"
        ),
        PoliticalSizingScenario(
            "cf_p50_t200", Decimal("50"), Decimal("200"), 4, "counterfactual"
        ),
        PoliticalSizingScenario(
            "cf_p100_t400", Decimal("100"), Decimal("400"), 4, "counterfactual"
        ),
        PoliticalSizingScenario(
            "cf_p150_t600",
            Decimal("150"),
        ...
        PoliticalSizingScenario(
            "cf_liquidity_ceiling", None, None, None, "capacity_only"
        ),
    )
